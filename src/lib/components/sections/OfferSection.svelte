...
<section id="oferta" class="snap-section">
	<div class="inner-scroll">
		<div class="glass-card p-8 md:p-10 text-white">
			<h2 class="font-heading text-[clamp(1.75rem,3.5vw,2.75rem)] font-bold mb-4">Oferta</h2>

			<p class="text-white/80 text-base leading-relaxed mb-5 max-w-3xl">
				Firma <strong class="text-white"
			...
			<p class="text-white/35 text-[0.7rem] leading-relaxed border-t border-white/10 pt-3">
